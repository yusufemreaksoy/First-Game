...
public class PlayerDashState : PlayerAbilityState
{
    ...
    public override void Enter()
    {
        ...
        player.DashTransformInticator.gameObject.SetActive(true);
    }
    ...
    public override void LogicUpdate()
    {
        ...
        if (!isExitingState)
        {
            ...
            if (isHolding)
            {
                ...
                player.DashTransformInticator.rotation = Quaternion.Euler(0f, 0f, angle - 45f);
                ...
                if(dashInputStop || Time.unscaledTime >= startTime + playerData.maxHoldTime)
                {
                    ...
                    player.DashTransformInticator.gameObject.SetActive(false);
                    PlaceAfterImage();
                }
            }
            else
    ...
    private void CheckIfSholdPlaceAfterImage()
    {
